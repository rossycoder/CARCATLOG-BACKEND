  ...
  async storeHistoryResult(vrm, result) {
    try {
      ...
      const historyData = {
        ...
        financeDetails:       result.financeDetails ? {
          amount:             result.financeDetails.amount             || 0,
          lender:             result.financeDetails.lender             || 'Unknown',
          type:               result.financeDetails.type               || 'unknown',
          agreementNumber:    result.financeDetails.agreementNumber    || null,
          startDate:          result.financeDetails.startDate          || null,
          term:               result.financeDetails.term               || null,
          contactNumber:      result.financeDetails.contactNumber      || null,
          vehicleDescription: result.financeDetails.vehicleDescription || null,
        } : { amount: 0, lender: 'Unknown', type: 'unknown' },
